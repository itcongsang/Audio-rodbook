...
function getAllBooks() {
  var res = Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_2__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_4__["db"].collection('books').limit(12)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (snapshot) {
    return snapshot.map(function (doc0) {
      return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["merge"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(doc0.data(), GetChanelName(doc0.data()))); // let rsa= GetChanelName(doc0.data());
      // let ob=new BookAndChannel({books: doc0.data(), nameChannel: rsa.pipe(val=>{return val})})
      // return ob;
    });
  }));
  return res;
...
//# sourceMappingURL=index.js.0d088eb8865621d12f5e.hot-update.js.map