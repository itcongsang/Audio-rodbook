...
function getAllBooks() {
  var res = Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_1__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_3__["db"].collection('books').limit(12)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (snapshot) {
    return snapshot.map(function (doc0) {
      var rsd = new _models_book__WEBPACK_IMPORTED_MODULE_4__["Book"](doc0.data());
      Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["combineLatest"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(rsd), GetChanelName(doc0.data())).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (val) {
        return val;
      }));
    });
  }));
...
function GetChanelName(object) {
  var rs = new _models_book__WEBPACK_IMPORTED_MODULE_4__["Book"](object);
  var channelId = rs.channelId;
  var res = Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_1__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_3__["db"].collection('channels').where('channelId', '==', channelId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
...
//# sourceMappingURL=index.js.3506df9597f92ba3a267.hot-update.js.map