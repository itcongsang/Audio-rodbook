...
function getAllBooks() {
  var res = Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["from"])(Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_1__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_3__["db"].collection('books').limit(12)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (snapshot) {
    return snapshot.map(function (doc0) {
      ...
      GetChanelName(channelId); // return collection(db.collection('channels').where('channelId', '==', channelId)).pipe(
...
function GetChanelName(e) {
  return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["from"])(Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_1__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_3__["db"].collection('channels').where('channelId', '==', e)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
...
//# sourceMappingURL=index.js.6fc451a747ecb98f3650.hot-update.js.map