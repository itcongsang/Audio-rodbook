...
function getAllBooks() {
  var res = Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["from"])(Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_2__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_4__["db"].collection('books').limit(12)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (snapshot) {
    return snapshot.map(function (doc0) {
      GetChanelName(doc0.data()).pipe(); // return collection(db.collection('channels').where('channelId', '==', channelId)).pipe(
...
function GetChanelName(object) {
  var rs = new _models_book__WEBPACK_IMPORTED_MODULE_5__["Book"](object.data());
...
//# sourceMappingURL=index.js.7521694426ddeb8e167d.hot-update.js.map