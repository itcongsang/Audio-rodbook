...
function GetChanelName(e) {
  var subject = new rxjs__WEBPACK_IMPORTED_MODULE_6__["BehaviorSubject"]("a");
  console.log("day k: " + subject);
  return Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_1__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_3__["db"].collection('channels').where('channelId', '==', e)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) {
    return res.map(function (doc1) {
      var resChennel = new _models_channel__WEBPACK_IMPORTED_MODULE_5__["Channel"](doc1.data());
      console.log("day ka: " + doc1);
    });
  })); // return namechanel;
}
...
//# sourceMappingURL=index.js.cf3b2b469aa80c3c6278.hot-update.js.map