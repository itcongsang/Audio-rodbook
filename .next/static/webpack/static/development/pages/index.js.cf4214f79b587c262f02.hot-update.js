...
function getAllBooks() {
  var res = Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_2__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_4__["db"].collection('books').limit(12)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (snapshot) {
    return snapshot.map(function (doc0) {
      ...
      return Object(rxfire_firestore__WEBPACK_IMPORTED_MODULE_2__["collection"])(_firebase_service__WEBPACK_IMPORTED_MODULE_4__["db"].collection('channels').where('channelId', '==', channelId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
        return res.map(function (doc1) {
          var resChennel = new _models_channel__WEBPACK_IMPORTED_MODULE_6__["Channel"](doc1.data()).name;
...
//# sourceMappingURL=index.js.cf4214f79b587c262f02.hot-update.js.map