...
import { FaBars, FaSearch, FaCloudUploadAlt, FaBell, FaUserCircle }  from 'react-icons/fa';
...
const HeaderTop: React.SFC<Props> =({clickShow, clickShowModal}) => {
  return (
          ...
          <div className="col-md-3">
            <div className="pull-right">
              ...
              <div className="in-line ds-mn">
                <div className="login-button" onClick={clickShowModal}>
